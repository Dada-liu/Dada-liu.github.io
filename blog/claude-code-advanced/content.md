...
在上篇文章[《一张图 → 完整应用：我用 ClaudeCode 复刻了这个开发流程》](https://dada-liu.github.io/#blog/ai-assisted-development)中，我用 4 个会话回合的实践验证了一个核心结论：**LLM 处理的是文字，从 idea 到文字的路径越短，效率越高。**
...
**相关资源：**
- 项目体验地址：[简历编辑器](https://dada-liu.github.io/resume-generator/)
- 前一个文章：[一张图 → 完整应用：我用 ClaudeCode 复刻了这个开发流程](https://dada-liu.github.io/#blog/ai-assisted-development)
